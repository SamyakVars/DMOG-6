class lvl1{
    constructor(){
        ...
        this.p2 = new Platform(870, this.h / 1.15, 160, 100)
        this.p3 = new Platform(1090, this.h / 1.18, 155, 150)
        this.p4 = new Platform(1250, this.h / 1.18, 35, 150)
        this.p5 = new Platform(1555, this.h / 1.18, 455, 150)
        this.p6 = new Platform(1865, this.h / 1.17, 35, 150)
        this.p7 = new Platform(2020, this.h / 1.28, 140, 40)
        this.p8 = new Platform(2210, this.h / 1.28, 140, 40)
        this.p9 = new Platform(2355, this.h / 1.17, 35, 150)
        this.p10 = new Platform(2440, this.h / 1.3, 25, 25)
        this.p11 = new Platform(2519, this.h / 1.3, 25, 25)
        this.p12 = new Platform(2595, this.h / 1.27, 35, 100)
        this.p13 = new Platform(2703, this.h / 1.47, 140, 40)
        this.p14 = new Platform(2809, this.h / 1.27, 35, 100)
        this.p15 = new Platform(2990, this.h / 1.32, 140, 40)
        this.p16 = new Platform(3205, this.h / 1.32, 140, 40)
        this.p17 = new Platform(3350, this.h / 1.2, 35, 150)
        this.p18 = new Platform(3440, this.h / 1.23, 35, 30)
        this.p19 = new Platform(3570, this.h / 1.32, 140, 40)
        this.p20 = new Platform(3690, this.h / 1.45, 35, 30)
        this.p21 = new Platform(3770, this.h / 1.63, 35, 30)
        this.p22 = new Platform(3845, this.h / 1.9, 35, 30)
        ...
        this.portal.depth = 1
        this.portal.debug = true
        this.portal.setCollider("circle", 0, 0, 30)

        // this.player.plr.debug = true
    ...
    play(){
        ...
        if(mousePressedOver(this.leftMove)){
            console.log("pressed")
        }
